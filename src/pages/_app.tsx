// app/page.tsx — This is the "holy sh*t" version
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {["Sarah’s Café", "Kiwi Plumbing Ltd", "Aroha Beauty Studio"].map((name) => (
              <Card key={name} className="overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all hover:-translate-y-4">
